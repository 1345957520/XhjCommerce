...
namespace Chj.Services.Catalog.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Order>>
    {
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_PRICE_MODEL_KEY = "Chj.totals.productprice-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_PRICE_PATTERN_KEY = "Chj.totals.productprice";
