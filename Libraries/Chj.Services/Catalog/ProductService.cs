...
namespace Chj.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// {0} : product ID
        /// </remarks>
        private const string PRODUCTS_BY_ID_KEY = "Chj.product.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTS_PATTERN_KEY = "Chj.product.";
        #endregion
        ...
        /// <param name="productIds">Product identifiers</param>
        /// <returns>Products</returns>
        public virtual IList<Product> GetProductsByCategoryIds(int[] categoryIds)
        {
