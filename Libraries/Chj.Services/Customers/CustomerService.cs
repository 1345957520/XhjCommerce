...
namespace Chj.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </remarks>
        private const string CUSTOMERROLES_ALL_KEY = "Chj.customerrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "Chj.customerrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERROLES_PATTERN_KEY = "Chj.customerrole.";
