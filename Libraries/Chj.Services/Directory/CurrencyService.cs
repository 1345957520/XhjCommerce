...
namespace Chj.Services.Directory
{
    ...
    public partial class CurrencyService : ICurrencyService
    {
        ...
        /// {0} : currency ID
        /// </remarks>
        private const string CURRENCIES_BY_ID_KEY = "Chj.currency.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CURRENCIES_ALL_KEY = "Chj.currency.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CURRENCIES_PATTERN_KEY = "Chj.currency.";
