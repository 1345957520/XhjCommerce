...
namespace Chj.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string FORUMGROUP_ALL_KEY = "Chj.forumgroup.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : forum group ID
        /// </remarks>
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "Chj.forum.allbyforumgroupid-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUMGROUP_PATTERN_KEY = "Chj.forumgroup.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUM_PATTERN_KEY = "Chj.forum.";
