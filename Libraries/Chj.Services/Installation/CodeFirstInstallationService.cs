...
using Chj.Services.Customers;
using Chj.Services.Helpers;
using Chj.Services.Localization;
using Chj.Services.Media;
using Chj.Services.Seo;

namespace Chj.Services.Installation
{
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Chj.Services.Messages.QueuedMessagesSendTask, Chj.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Chj.Services.Common.KeepAliveTask, Chj.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Chj.Services.Customers.DeleteGuestsTask, Chj.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Chj.Services.Caching.ClearCacheTask, Chj.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Chj.Services.Logging.ClearLogTask, Chj.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    Seconds = 900,
                    Type = "Chj.Services.Directory.UpdateExchangeRateTask, Chj.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
