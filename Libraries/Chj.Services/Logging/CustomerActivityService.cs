...
namespace Chj.Services.Logging
{
    /// <summary>
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "Chj.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "Chj.activitytype.";
