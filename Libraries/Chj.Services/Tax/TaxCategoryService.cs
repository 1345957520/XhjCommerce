...
namespace Chj.Services.Tax
{
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string TAXCATEGORIES_ALL_KEY = "Chj.taxcategory.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : tax category ID
        /// </remarks>
        private const string TAXCATEGORIES_BY_ID_KEY = "Chj.taxcategory.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TAXCATEGORIES_PATTERN_KEY = "Chj.taxcategory.";
