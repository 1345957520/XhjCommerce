...
namespace Chj.Plugin.Misc.FacebookShop.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Category>>
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_NAVIGATION_MODEL_KEY = "Chj.plugins.misc.facebookshop.category.navigation-{0}-{1}-{2}";
        public const string CATEGORY_NAVIGATION_PATTERN_KEY = "Chj.plugins.misc.facebookshop";
