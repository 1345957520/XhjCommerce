...
using Chj.Plugin.Payments.AuthorizeNet.Controllers;
using Chj.Plugin.Payments.AuthorizeNet.net.authorize.api;
...
namespace Chj.Plugin.Payments.AuthorizeNet
{
    /// <summary>
    ...
    public class AuthorizeNetPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Payments.AuthorizeNet.Controllers" }, { "area", null } };
        }
