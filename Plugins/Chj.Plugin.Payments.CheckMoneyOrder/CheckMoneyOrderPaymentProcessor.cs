...
namespace Chj.Plugin.Payments.CheckMoneyOrder
{
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Payments.CheckMoneyOrder.Controllers" }, { "area", null } };
        }
