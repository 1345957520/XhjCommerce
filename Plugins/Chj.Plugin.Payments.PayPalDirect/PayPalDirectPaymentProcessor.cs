...
using Chj.Plugin.Payments.PayPalDirect.Controllers;
...
namespace Chj.Plugin.Payments.PayPalDirect
{
    ...
    public class PayPalDirectPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Payments.PayPalDirect.Controllers" }, { "area", null } };
        }
