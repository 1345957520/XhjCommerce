...
namespace Chj.Plugin.Payments.PurchaseOrder
{
    ...
    public class PurchaseOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Payments.PurchaseOrder.Controllers" }, { "area", null } };
        }
