...
namespace Chj.Plugin.Shipping.FixedRateShipping
{
    /// <summary>
    ...
    public class FixedRateShippingComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Shipping.FixedRateShipping.Controllers" }, { "area", null } };
        }
