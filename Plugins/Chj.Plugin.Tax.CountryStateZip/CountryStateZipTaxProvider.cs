...
using Chj.Plugin.Tax.CountryStateZip.Infrastructure.Cache;
...
namespace Chj.Plugin.Tax.CountryStateZip
{
    ...
    public class CountryStateZipTaxProvider : BasePlugin, ITaxProvider
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Chj.Plugin.Tax.CountryStateZip.Controllers" }, { "area", null } };
        }
