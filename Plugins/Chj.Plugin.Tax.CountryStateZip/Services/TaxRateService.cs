...
namespace Chj.Plugin.Tax.CountryStateZip.Services
{
    /// <summary>
    /// Tax rate service
    /// </summary>
    ...
    {
        #region Constants
        private const string TAXRATE_ALL_KEY = "Chj.taxrate.all-{0}-{1}";
        private const string TAXRATE_PATTERN_KEY = "Chj.taxrate.";
        #endregion
