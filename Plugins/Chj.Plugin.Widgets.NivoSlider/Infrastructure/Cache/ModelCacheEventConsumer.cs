...
namespace Chj.Plugin.Widgets.NivoSlider.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Chj.plugins.widgets.nivosrlider.pictureurl-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Chj.plugins.widgets.nivosrlider";
