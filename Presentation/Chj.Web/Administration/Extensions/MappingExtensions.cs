using System;
using AutoMapper;
using Chj.Admin.Models.Blogs;
using Chj.Admin.Models.Catalog;
using Chj.Admin.Models.Cms;
...
using Chj.Admin.Models.Vendors;
...
namespace Chj.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        {
            //this method is very similar to the same one in Chj.Web project
