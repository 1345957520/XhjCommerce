...
namespace Chj.Data.Tests
{
    ...
    public abstract class PersistenceTest
    {
        ...
        {
            string testDbName = "Data Source=" + (System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location)) + @"\\Chj.Data.Tests.Db.sdf;Persist Security Info=False";
            return testDbName;
        }        
