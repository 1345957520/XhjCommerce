...
using Chj.Services.Tests.Directory;
using Chj.Services.Tests.Discounts;
using Chj.Services.Tests.Payments;
using Chj.Services.Tests.Shipping;
using Chj.Services.Tests.Tax;
using NUnit.Framework;

namespace Chj.Services.Tests
{
    [TestFixture]
